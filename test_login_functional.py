...
def test_valid_login_functional(driver):
    ...
    time.sleep(2)
    result = driver.find_element(By.XPATH, f"//a[contains(text(), 'Bui Truong Thinh')]").text
    time.sleep(1)
    assert "Bui Truong Thinh" in result
...
def test_empty_pwd(driver):
    ...
    driver.find_element(By.ID, "usrname").send_keys("bokho")
